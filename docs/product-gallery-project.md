...
| S18-013 | Nissan GTR Liberty Walk | ✅ já estava certa | ✅ 3 fotos (frente, traseira, caixa) | `052` — **rodar no Supabase** | Marca real GULY preservada. Foto de traseira refeita 1x (rodas/lateral saíram distantes do real; corrigida usando a lateral impressa na caixa) |
| S18-014, 015, 017 | (3 restantes) | — | — | — | Fotos brutas já em `products-raw/` — ainda não processados. S18-014 (Ferrari Enzo) é o próximo da fila |
