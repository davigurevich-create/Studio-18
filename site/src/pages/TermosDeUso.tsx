const sections = [
  ...
  },
  {
    ...
    body:
      'Os preços exibidos incluem os tributos aplicáveis e estão em reais (BRL). O frete é calculado à parte, conforme o CEP de entrega, e exibido antes da confirmação da compra. Pagamentos são processados via Rede (cartão de crédito).',
  },
  {
    title: '4. Entrega',
    body:
